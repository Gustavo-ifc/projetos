...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $resposavel = isset($_POST['contato'])?$_POST['contato']:0;
    $salario = isset($_POST['contato'])?$_POST['contato']:0;
    ...
    elseif ($tipo== "2")
        $usuario = new Aluno($id,$nome,$email,$senha, $matricula, $contato, $responsavel);
    if ($acao == 'salvar')
        if ($id > 0)
